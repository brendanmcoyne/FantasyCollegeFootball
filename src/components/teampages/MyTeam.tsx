                                ...
                                selectedStatsUnit.isOpponent ? (
                                    <>
                                        <div>
                                            ...
                                            <strong>
                                                {(collegeTeam.stats.passing_yards_allowed ?? 0)
                                                    .toLocaleString()}
                                            </strong>
                                            {' • '}
                                            <strong>
                                                {formatRank(
                                                    getStatRank(
                                                        ...
                                                        collegeTeam.id,
                                                        (team) =>
                                                            -(team.stats.passing_yards_allowed ?? 0)
                                                    )
                                                )}
                                            </strong>
                                        </div>
                                            ...
                                            <strong>
                                                {formatRank(
                                                    getStatRank(
                                                        ...
                                                        collegeTeam.id,
                                                        (team) =>
                                                            -(team.stats.passing_yards_allowed_per_game ?? 0)
                                                    )
                                                )}
                                            </strong>
                                        </div>
                                ...
                                selectedStatsUnit.isOpponent ? (
                                    <>
                                        <div>
                                            ...
                                            <strong>
                                                {(collegeTeam.stats.rushing_yards_allowed ?? 0)
                                                    .toLocaleString()}
                                            </strong>
                                            {' • '}
                                            <strong>
                                                {formatRank(
                                                    getStatRank(
                                                        ...
                                                        collegeTeam.id,
                                                        (team) =>
                                                            -(team.stats.rushing_yards_allowed ?? 0)
                                                    )
                                                )}
                                            </strong>
                                        </div>
                                            ...
                                            <strong>
                                                {formatRank(
                                                    getStatRank(
                                                        ...
                                                        collegeTeam.id,
                                                        (team) =>
                                                            -(team.stats.rushing_yards_allowed_per_game ?? 0)
                                                    )
                                                )}
                                            </strong>
                                        </div>
                                    ...
                                    <>
                                        <div>
                                            Rushing Yards:{' '}
                                            <strong>
                                                {(collegeTeam.stats.rushing_yards ?? 0)
                                                    .toLocaleString()}
                                            </strong>
                                            {' • '}
                                            <strong>
                                            ...
                                            <strong>
                                                {formatRank(
                                                    getStatRank(
                                                        ...
                                                        collegeTeam.id,
                                                        (team) =>
                                                            team.stats.rushing_yards_per_game ?? 0
                                                    )
                                                )}
                                            </strong>
                                        </div>
                                            ...
                                            <strong>
                                                {formatRank(
                                                    getStatRank(
                                                        ...
                                                        collegeTeam.id,
                                                        (team) =>
                                                            team.stats.passing_yards_per_game ?? 0
                                                    )
                                                )}
                                            </strong>
                                        </div>
                                            ...
                                            <strong>
                                                {formatRank(
                                                    getStatRank(
                                                        ...
                                                        collegeTeam.id,
                                                        (team) =>
                                                            team.stats.total_yards_per_game ?? 0
                                                    )
                                                )}
                                            </strong>
                                        </div>
